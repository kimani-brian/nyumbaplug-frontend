            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  aria-label="Password"
                />
                <button type="button" onClick={() => setShowPwd(!showPwd)} className="text-slate-400 hover:text-slate-600" aria-label="Toggle password visibility" aria-pressed={showPwd}>
