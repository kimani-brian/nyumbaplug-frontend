  ...
  return (
    <main className="max-w-3xl mx-auto px-5 sm:px-8 py-8 space-y-6">
      <div>
        ...
        <h1 className="display font-semibold text-3xl text-nyumba-ink">Customer profile</h1>
        <p className="text-sm text-slate-500 mt-1">Keep your contact details up to date so property managers can reach you about rentals.</p>
      </div>
          ...
          {editing ? (
            ...
            <div className="space-y-5">
              <div className="grid sm:grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  <span className="text-[10px] uppercase font-semibold text-slate-400 block mb-1">Preferred Location</span>
                  <span className="text-slate-900 flex items-center gap-1.5">
