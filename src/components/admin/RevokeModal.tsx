...
export const RevokeModal: React.FC<Props> = ({ isOpen, onClose, landlord, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl max-w-md w-full p-6 relative shadow-2xl border border-red-200">
        ...
        <div className="flex items-center gap-2 text-red-600 mb-3">
          ...
          <h3 className="text-lg font-bold text-slate-900">Revoke Property Manager Profile</h3>
        </div>

        <div className="p-3.5 bg-red-50 border border-red-200 rounded-xl text-xs text-red-900 mb-4 space-y-1">
        ...
        <form onSubmit={handleRevoke} className="space-y-4">
          <div>
            ...
            <textarea
              ...
              className="w-full text-sm border border-nyumba-line rounded-xl p-2.5 bg-nyumba-cream focus:ring-2 focus:ring-red-500 focus:outline-none"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-red-600 hover:bg-red-700 disabled:bg-slate-300 text-white font-bold py-2.5 rounded-xl text-sm transition"
          >
